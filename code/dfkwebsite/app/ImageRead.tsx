...
export default function ImageRead(props: MyProps) {
  return (
    <div className="h-[500px] flex flex-row w-full my-10 gap-20 justify-between">
      <div className={`min-w-[700px] max-w-[700px] h-full flex-grow relative overflow-hidden ${props.order ? 'order-1': 'order-0'}`}>
      ...
      <div className={`flex flex-col flex-grow text-white ${props.order ? 'order-0': 'order-1 text-left' }`}>
        <h1 className="font-extrabold text-5xl">{props.title}</h1>
